...
public class IngresoDAO implements CrudIngresoInterface<Ingreso, DetalleIngreso> {
    ...
    public List<Ingreso> listar(String texto, int totalPorPagina, int numPagina) {
        ...
        try {
            ps = CON.conectar().prepareStatement("SELECT i.id, i.usuario_id, u.nombre AS usuario_nombre, i.persona_id, p.nombre AS persona_nombre, i.tipo_comprobante, i.serie_comprobante, i.num_comprobante, i.fecha, i.impuesto, i.total, i.estado FROM ingreso i INNER JOIN persona p ON i.persona_id=p.id "
