...
public class UsuarioDAO implements CrudPaginadoInterface<Usuario> {
    ...
    public List<Usuario> listar(String texto, int totalPorPagina, int numPagina) {
        ...
        try {
            ps = CON.conectar().prepareStatement("SELECT u.id, u.rol_id, r.nombre as rol_nombre, u.nombre, u.tipo_documento, u.num_documento, u.direccion, u.telefono, u.email, u.clave, u.activo "
    ...
    public Usuario login(String email, String clave) {
        Usuario usu = null;
        try {
            ps = CON.conectar().prepareStatement("SELECT u.id, u.rol_id, r.nombre as rol_nombre, u.nombre, u.tipo_documento, u.num_documento, u.direccion, u.telefono, u.email, u.activo "
                    + "FROM usuario u inner join rol r ON u.rol_id=r.id WHERE u.email=? AND clave=?");
