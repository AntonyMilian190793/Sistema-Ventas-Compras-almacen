 ...
 */
public class FrmSeleecionarArticuloCompra extends javax.swing.JDialog {
    ...
    public FrmSeleecionarArticuloCompra(java.awt.Frame parent, FrmIngreso frm, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.vista = frm;
        this.setTitle("Seleecionar artículos para el ingreso");
    ...
    private void listar(String texto, boolean paginar) {
        ...
        if (paginar == true) {
            tablaListado.setModel(this.CONTROL.listar(texto, totalPorPagina, this.numPagina));
        } else {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(cboCategoria, 0, 230, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(txtPrecioVenta, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtDescripcion.getText().length() > 255) {
            JOptionPane.showMessageDialog(this, "Debes ingresar una descripción y no debe ser mayor a 255 caracteres, es obligatorio.", "Sistema", JOptionPane.WARNING_MESSAGE);
    ...
    private void btnSeleecionarArticuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleecionarArticuloActionPerformed
        if (tablaListado.getSelectedRowCount() == 1) {
            ...
            this.mensajeError("Debe seleccionar 1 artículo que desea agregar al detalle.");
        }
