...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema de Ventas y Compras");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(escritorio, javax.swing.GroupLayout.DEFAULT_SIZE, 1076, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(escritorio, javax.swing.GroupLayout.DEFAULT_SIZE, 695, Short.MAX_VALUE)
        );
    ...
    private void itemConsultaVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemConsultaVentasActionPerformed
        FrmConsultaVentasFechas frm = new FrmConsultaVentasFechas();
        escritorio.add(frm);
        frm.setVisible(true);
    ...
    private void itemConsultaComprasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemConsultaComprasActionPerformed
        FrmConsultaIngresosFechas frm = new FrmConsultaIngresosFechas();
        escritorio.add(frm);
        frm.setVisible(true);
